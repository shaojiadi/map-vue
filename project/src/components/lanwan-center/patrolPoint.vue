...
<!-- 巡检画面 巡检记录 -->
  <ul class="camera">
      <div class="f-camera-popup" ref="camera-popup">
        ...
        <div class="f-camera-popup-content">
          <div class="f-camera-popup-video" v-if="isInPut === 0">
            ...
            <p class="popup-content-bottom">
              设备详细地址：<span>{{ patrolList[0].local }}</span>
            </p>
            <div class="popup-bottom">
              <p class="popup-content-bottom">
                巡检项目：<span>A区生产巡检</span>
              </p>
              <p class="popup-content-bottom">
                执行率：<span>35%</span>
              </p>
...
export default {
  data() {
    return {
      isInPut: 0,
      videoList: [],
      activeCameraIndexCode: "5a4c292db554419cb932b985ab98df74",
      cameraId: 1,
  ...
  methods: {
    getUrl() {
      ...
      console.log(cameraIndexCode,888)
