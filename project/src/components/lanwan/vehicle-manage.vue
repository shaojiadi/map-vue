    ...
    <div class="vehicle">
      <div class="vehicle-left">
        <v-wrap class="item-wrap" style="min-height: 4.8rem">
          <h3 class="snap-title" style="margin-top: 0.25rem; margin-bottom: 0rem">
            车位概览
          </h3>
          <ul class="garage">
            <li
          ...
          <ul class="garage-statistics">
            <li class="garage-statistics-item" v-for="(item, index) in garageStatisticsList" :key="index">
              <h3 class="garage-statistics-number" v-if="(typeof item.number) != 'number'">
                {{ item.number }}
              </h3>
              <v-countup
                v-else
        ...
        <div class="f-table personnel">
          ...
          >
            ...
            <el-table-column
              ...
              show-overflow-tooltip
            >
              <template slot-scope="scope">{{scope.row.cpPassDoorwayName | empty}}</template>
            </el-table-column>
            <el-table-column
              prop="cpPassType"
              label="出/入库"
            ...
            <el-table-column
              ...
              show-overflow-tooltip
            >
              <template slot-scope="scope">{{scope.row.cpPassTime | datetime}}</template>
            </el-table-column>
          </el-table>
        </div>
        ...
        .then(res => {
          ...
          this.tableData.forEach((val, index) => {
            this.$set(
              val,
              "company",
              this.carTableList[Math.floor(Math.random() * 10)]
            );
