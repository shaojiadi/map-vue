<template>
  <ul class="camera">
    ...
    >
      <div class="g-left-bg" :class="{ rotate: item.rotate }">
        <div :class="{ rotateBack: item.rotate }" class="rotateD">
          <p class="title">{{ item.title }}</p>
          <div class="mt">
            <span class="q-title">告警原因：</span>
            <span class="q-text"> {{ item.reason }} </span>
          </div>
          <div class="mt">
            <span class="q-title">告警时间：</span>
            <span class="q-text"> {{ item.record }} </span>
          </div>
          <div class="mt">
            <span class="q-title">告警位置：</span>
            <span class="q-text"> {{ item.locals }} </span>
          </div>
          <div class="mt">
            <span class="q-title"> 停留区域： </span>
            <span class="q-text"> {{ item.area }} </span>
          </div>
          <div class="flex-box2">
            <div class="warn-btn" @click="showJianKong(item)">调取监控</div>
            <div class="warn-btn" @click="noWarnPoint(item, index)">
              告警解除
            </div>
          </div>
        </div>
      ...
      <img
        ...
        :src="`/static/bounced-img/${
          item.isPerson ? 'person-warn' : 'xiaofang-warn'
        }.png `"
        alt
      />
    </li>
